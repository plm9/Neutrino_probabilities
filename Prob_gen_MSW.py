...
for a in flavors:
    for b in flavors:
        if bool or a==b:
            expression=Prob_a_to_b_Gen_MSW(a,b,"normal").subs([(s_12,sin(theta_MSW(1,2))),(c_12,cos(theta_MSW(1,2))),(c_13,cos(theta_MSW(1,3))),(c_23,cos(theta_MSW(2,3))),(s_13,sin(theta_MSW(1,3))),(s_23,sin(theta_MSW(2,3))),(d_cp,delta_cp),(D_m_21,D_mass(2,1)),(D_m_32,D_mass(3,2)),(D_m_31,D_mass(3,1))])
            expression_anti=Prob_a_to_b_Gen_MSW(a,b,"anti").subs([(s_12,sin(theta_MSW(1,2))),(c_12,cos(theta_MSW(1,2))),(c_13,cos(theta_MSW(1,3))),(c_23,cos(theta_MSW(2,3))),(s_13,sin(theta_MSW(1,3))),(s_23,sin(theta_MSW(2,3))),(d_cp,delta_cp),(D_m_21,D_mass(2,1)),(D_m_32,D_mass(3,2)),(D_m_31,D_mass(3,1))])
            expression_diff=(Prob_a_to_b_Gen_MSW(a,b,"normal")-Prob_a_to_b_Gen_MSW(a,b,"anti")).subs([(s_12,sin(theta_MSW(1,2))),(c_12,cos(theta_MSW(1,2))),(c_13,cos(theta_MSW(1,3))),(c_23,cos(theta_MSW(2,3))),(s_13,sin(theta_MSW(1,3))),(s_23,sin(theta_MSW(2,3))),(d_cp,delta_cp),(D_m_21,D_mass(2,1)),(D_m_32,D_mass(3,2)),(D_m_31,D_mass(3,1))])
...
for events,antievents,diff_events,name in zip(saving_list,saving_list_anti,saving_list_diff,name_help):
    ...
    sns.heatmap(events[1],cmap="Spectral",center=0).figure.axes[-1].set_ylabel(events[0],size=14) 
    ...
    plt.savefig('MSW-effect/Gen_prob_pi2_%s_for_%s.pdf' % (name,delta_cp))
    #plt.show()

    #Here we plot for the anti neutinos
    plt.figure(figsize=(8,6))
    sns.heatmap(antievents[1],cmap="Spectral",center=0).figure.axes[-1].set_ylabel(antievents[0],size=14) 
    ...
    #plt.title(events[0],fontsize=14) 
    plt.savefig('MSW-effect/Gen_prob_anti_%s_for_%s.pdf' % (name,delta_cp))
    #plt.show()


    plt.figure(figsize=(8,6))
    sns.heatmap(diff_events[1],cmap="Spectral",center=0).figure.axes[-1].set_ylabel(events[0]+"-"+antievents[0],size=14) 
    ...
    plt.title(diff_events[0]+r",$\delta={:}^o$".format(delta_cp),fontsize=14) 
    plt.savefig('MSW-effect/Gen_diff_%s_%s_to.pdf' % (delta_cp,name))
    plt.show()
